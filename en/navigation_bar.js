...
document.write('<a class="nav-link text-light" href="/all-index.html">General Index of the Manuscript<span class="sr-only">(current)</span></a>');
document.write('</li>');
document.write('<li class="nav-item">');
document.write('<a class="nav-link text-light" href="/sekiguchi.html">Who is Sekiguchi Tsugio?</a>');
document.write('</li>');
document.write('<li class="nav-item">');
document.write('<a class="nav-link text-light" href="/about.html">About</a>');
document.write('</li>');
document.write('<li class="nav-item">');
document.write('<a class="nav-link text-light" href="/inquiry.html">Inquiry</a>');
document.write('</li>');
document.write('<li class="nav-item">');
